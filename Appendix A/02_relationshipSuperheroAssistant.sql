...
ALTER TABLE superhero CONSTRAINT fk_power FOREIGN KEY(power_id) REFERENCES power(id) ON CASCADE DELETE
ALTER TABLE power CONSTRAINT fk_superhero FOREIGN KEY(superhero_id) REFERENCES superhero(id) ON CASCADE DELETE
ALTER TABLE assistant CONSTRAINT fk_superhero FOREIGN KEY(superhero_id) REFERENCES superhero(id) ON CASCADE DELETE
